...
export const DEFAULT_AVATAR_ASSETS = {
  // Body is split into independently replaceable layers.
  // `body`/`innerWear` aliases are kept for older code and saved data.
  body: '/assets/avatar/base/body_base.png',
  bodyBase: '/assets/avatar/base/body_base.png',
  innerWear: '/assets/avatar/base/body_inner.png',
  bodyInner: '/assets/avatar/base/body_inner.png',
  bodyLeftArmDefault: '/assets/avatar/base/body_left_arm_default.png',
  bodyRightArmDefault: '/assets/avatar/base/body_right_arm_default.png',
  bodyRightArmHoldOneHandWeapon: '/assets/avatar/base/body_right_arm_hold_one_hand_weapon.png',
  bodyLeftArmTwoHanded: '/assets/avatar/base/body_left_arm_two_handed.png',
  bodyRightArmTwoHanded: '/assets/avatar/base/body_right_arm_two_handed.png',
